---
title: "Endotherm Model Tutorial: example simulations"
...
treg.lab <- c("core temperature (C)", "lung temperature (C)", "dorsal skin temperature (C)", "ventral skin temperature (C)", "dorsal fur/feather-air interface temperature (C)", "ventral fur-air interface temperature (C)", "current ratio between long and short axis due to postural change (-)", "breathing rate multiplier (-)", "part of the skin surface that is wet (pct)", "thermal conductivity of flesh (W/mC)", "effective thermal conductivity of fur/feathers (W/mC)", "thermal conductivity of dorsal fur/feathers (W/mC)", "thermal conductivity of ventral fur/feathers (W/mC)", "thermal conductivity of compressed fur/feathers (W/mC)", "depth of dorsal fur (m)", "depth of ventral fur (m)", "Q10 multiplier on metabolic rate (-)")
